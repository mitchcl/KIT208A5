...
public class OculusControllerInteraction : MonoBehaviour
{
    ...
    private void Update()
    {
        if (OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger))
        {
            ...
            UnityEngine.Debug.Log("PrimaryIndexTrigger");
            ...
            UnityEngine.Debug.Log("Did it hit sxomething:" + Physics.Raycast(ray0, out hit0, raycastDistance));
            //UnityEngine.Debug.Log("Does it have Door tag:" + hit0.collider.CompareTag("Door"));
            //UnityEngine.Debug.Log("Does it have Equipment tag:" + hit0.collider.CompareTag("Equipment"));
